...
if(options.doBeamforming)
	...
	if(options.beamforming.doDirectivityIndex)
		results.beamforming.directivityIndex = ...
			directivityIndexFromWeights(options.beamforming.weights...
			                           ,options.frequency...
			                           ,options.geometry...
			                           ,options.beamforming.directivityIndex.target...
			                           ,options.c);
	end
