...
eopen([fileparts(opt.tmpDir) 'distance_filter_snr-dependency.eps']);
eglobpar;
eXAxisSouthScale = [-30 5 30];
exAxisSouthLabel = 'input SIR';
eYAxisWestLabel = 'SIR improvement';
eplot([-30:5:30],snrMat);
eclose;
